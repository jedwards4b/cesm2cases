...
# -----------------------------------------------------------------------------
# NOTICE: This script was custom-generated for /glade/p/work/jedwards/sandboxes/cesm2_0_alpha/cime.jet/scripts/foo.
#
#         DO NOT COPY to another case!
#
#         Use this script ONLY in /glade/p/work/jedwards/sandboxes/cesm2_0_alpha/cime.jet/scripts/foo.
# -----------------------------------------------------------------------------

set sourcemod_dir  = /glade/p/work/jedwards/sandboxes/cesm2_0_alpha/cime.jet/scripts/foo/SourceMods/src.cism/glimmer-cism
set cism_confIOdir = /glade/p/work/jedwards/sandboxes/cesm2_0_alpha/cime.jet/scripts/foo/Buildconf/cismIOconf
